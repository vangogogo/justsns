                                ...
                                success:function(msg) {
                                        ...
                                        if (myData && myData.length > 0) {
                                                ...
                                                $.each(myData, function(i, n) {
                                                        ...
                                                        arr.push("<a href='javascript:void(0)' title='" + n.friendUserName + "' name='" + n.fUid + "'><input type='hidden' name='friend_ids[" + n.fUid + "]' value='" + n.fUid + "'/><img width='20' height='20' src='" + n.friendHeadPic + "' title='" + n.fUid + "' alt='' />" + n.friendUserName + "</a>");
                                                });
                ...
                addUser:function(fUid, name, image) {
                        ...
                        if ($this.opts.selectType == "multiple") {
                                if ($.inArray(fUid, $this.resultArr) == -1) {
										...
										//biner添加，直接增加input，可以post提交。
                                        $($this.opts.resultContainer).append("<a href='javascript:void(0)' name='" + fUid + "'><input type='hidden' name='friend_ids[" + fUid +"]' value='" + fUid + "'/><img width='20' height='20' src='" + image + "' title='" + fUid + "' alt='' />" + name + "<span title='移除该好友'>移除该好友</span></a>");
