...
function insertImg1(imgpath) {
	var html1='<img src='+imgpath+' id="ImageDrag" class="imagePhoto" >';
	var html2='<img src='+imgpath+' id="ImageIcon" class="imagePhoto" onload="go();move();">';
	$('#ImageDragContainer').html(html1);
	$('#IconContainer').html(html2);
	$('#tbface').show();
	$('#userfacediv').hide();
}
