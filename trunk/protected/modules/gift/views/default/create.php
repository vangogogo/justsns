...
<div class="baikeUserPage">
	<?php $this->widget('CLinkPager',array('pages'=>$pages)); ?>
        ...
        <tr>
          ...
          <td>
				<?php echo CHtml::activeTextArea($model,'content',array('class'=>'wenhouInput2'));?>
          </td>
        </tr>
        <tr>
          <td  width="120" align="right"></td>
          <td>
          	<?php echo CHtml::activeRadioButtonList($model,'access',$this->accessOptions,array('separator'=>'<br/>')); ?>
        </td>
        </tr>
        <tr>
          <td  width="120" align="right" height="40"></td>
          <td align="right"><input type="image" src="images/system/sendWenhou.gif" name="button" id="button" value="提交" /></td>
        </tr>
      </table>
