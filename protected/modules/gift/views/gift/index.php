			...
			<ul>
				<?php foreach ($category['gifts'] as $key => $gift):?>
					<li class='gifts hand' title="点击选择" id="gift<?php echo $gift['id'];?>" onclick="sendGift(<?php echo $gift['id'];?>)">
						<?php echo CHtml::image($this->image_dir.$gift->img,$gift->name,array('title'=>$gift->desc));?>
						<br/>
						<?php echo $gift['name'];?>
						<br/>
	...
	<form action="__URL__/send/" method='post' onsubmit='return check()'>
		...
		<div style="margin-top:30px;">
			...
			<div style="margin-top:20px;">
				...
				<textarea cols="50" rows="6" class="Text20" name='sendInfo'>
				</textarea>
			</div>
			<div>
