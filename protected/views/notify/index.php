	...
	<ul>
		...
		<li class="btmlineD" id="notify_<?php echo $notify->id;?>">
			...
			<div class="left" style="width:90%">
				<h3><div class="right alR"><div class="left"><em><?php echo friendlyDate('Y-m-d H:i',$notify->ctime);?></em></div><div class="left">

                <?php #echo CHtml::link('删除',array('doDelNotify','notify_id'=>$notify->id),array('class'=>'a_confirm_link','title'=>'确认删除通知?'))?>

</div></div><strong><?php echo $notify->type;?></strong></h3>
			<div>
			<div class="right alR">
					<!-- TIP -->
					<?php
