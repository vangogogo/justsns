...
{	
	...
	public function afterSave($event)
	{
		...
		// 获得该操作资源的名称 如 ‘产品’、‘新闻’
		$resource_name = $this->Owner->getResourceName();
		// 获得该操作资源的类名
		...
		// AR中的deleteMark()方法
		if($newattributes['is_delete'] == 1 AND $oldattributes['is_delete'] == 0)
		{
		...
		$info = array(
			...
			'log_model_pk'=>$pk,
			'log_model_attributes_old'=>$model_attributes_old,
			'log_model_attributes_new'=>$model_attributes_new,
		);
		$log->mylog($info);
	}
