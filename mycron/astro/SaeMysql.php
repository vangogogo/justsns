...
define('SAE_ACCESSKEY','lockphp1_admin');
define('SAE_SECRETKEY','CCMq/X5&VlF!');
define('SAE_DBNAME','lockphp1_yiisns');
...
class SaeMysql 
{
    ...
    {
        $this->appname =  'lockphp1_' . $appname;
    }
